...
dir.create(here("01_Data", "04_Campanias", "20220725"))

write_excel_csv(archivo_citatorios_daily,
                here("01_Data", "04_Campanias", "20220725", "archivo_citatorios_20220725.csv"),
                na = "")
...
write_excel_csv(archivo_calculadoras_daily,
                here("01_Data", "04_Campanias", "20220725", "archivo_calculadoras_20220725.csv"),
                na = "")
